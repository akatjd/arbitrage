...
class BybitFutures(BaseFuturesExchange):
    ...
    def __init__(self, api_key: str = None, secret: str = None):
        ...
        logger.info("Initialized Bybit Futures exchange")
    ...
    async def fetch_all_funding_rates(self) -> List[FundingRateInfo]:
        ...
        try:
            ...
            logger.error(f"Error fetching all Bybit funding rates: {e}")
        return rates
    ...
    async def close(self):
        ...
        try:
            ...
            logger.info("Bybit Futures connection closed")
        except Exception as e:
            logger.error(f"Error closing Bybit connection: {e}")
